...
| Clave | Tipo | Descripción |
|-------|------|-------------|
| `urlCorta` | `string` | URL corta para compartir en redes, WhatsApp o mensajes (ej. `"https://bit.ly/panificacioncolombres"`). Si está vacío no se usa. Ver [URL_CORTA.md](URL_CORTA.md). |
